...
public class QuizActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(!answered){
                    if(rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(QuizActivity.this, "Nu a fost selectet niciun raspuns.", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    showNextQuestion();
                }
    ...
    private void updateContDownText(){
    ...
    private void showSolution(){
        ...
        if(questionCounter < questionCountTotal){
            buttonConfirmNext.setText("Urmatoarea intrebare");
        }else{
            buttonConfirmNext.setText("Incheie");
        }
    }
    ...
    public void onBackPressed() {
        if(backPressedTime + 2000 > System.currentTimeMillis()){
            ...
            Toast.makeText(this, "Apasa back inca odata pentru a incheia quizul.", Toast.LENGTH_SHORT).show();
        }
